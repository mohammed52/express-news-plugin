...
(function() {
  ...
  function getColorPicker(callback) {
    var value,
      ...
      colorFrame = document.body.appendChild(document.createElement("iframe")),
    ...
    colorPicker = new ColorPicker(slideElement, pickerElement, function(hex, hsv, rgb, mousePicker, mouseSlide) {
      console.log('colorPicker = new ColorPicker(slideElement, pickerElement, function(hex, hsv, rgb, mousePicker, mouseSlide) {');
      value = hex;
  ...
  function getNote() {
    var element = document.createElement("div"),
      ...
      gripContainer = document.createElement("div"),
      container = document
        .createElement("div"),
  ...
  function getToolbox() {
    ...
    function createCommandButton(className, title, command) {
      createButton(className, title, function() {
        console.log('createButton(className, title, function() {');
    ...
    collapseButton = createButton("collapse-left-button", "Show/Hide Editor Toolbox", function() {
      console.log('collapseButton = createButton("collapse-left-button", "Show/Hide Editor Toolbox", function() {');
      toggle();
    }, doc.body);
    ...
    fontSizeButton = createSelectButton("Font Size", "Font Size", ["1", "2", "3", "4", "5", "6", "7"], function(event) {
      console.log('fontSizeButton = createSelectButton("Font Size", "Font Size", [ "1", "2", "3", "4", "5", "6", "7" ], function(event) {');
    ...
    fontFamilyButton = createSelectButton("Font Family", "Font Family", ["cursive", "monospace", "sans-serif", "serif"], function(event) {
      console.log('fontFamilyButton = createSelectButton("Font Family", "Font Family", [ "cursive", "monospace", "sans-serif", "serif" ], function(event) {');
      if (event.target.value)
    ...
    colorButton = createButton("color-button", "Select Text Color", function() {
      console.log('colorButton = createButton("color-button", "Select Text Color", function() {');
      colorPicker.setPosition(frame.offsetLeft + colorButton.offsetLeft + 10);
      bgColorPicker.hide();
      colorPicker.toggle();
    });
    colorView = createColorView("Set Text Color", function() {
      console.log('colorView = createColorView("Set Text Color", function() {');
    ...
    colorPicker.getElement().addEventListener("click", function() {
      console.log('colorPicker.getElement().addEventListener("click", function() {');
      colorView.style.backgroundColor = colorPicker.getValue();
    }, false);
    bgColorButton = createButton("bgcolor-button", "Select Text Background Color", function() {
      console.log('bgColorButton = createButton("bgcolor-button", "Select Text Background Color", function() {');
    ...
    bgcolorView = createColorView("Set Text Background Color", function() {
      console.log('bgcolorView = createColorView("Set Text Background Color", function() {');
    ...
    bgColorPicker.getElement().addEventListener("click", function() {
      console.log('bgColorPicker.getElement().addEventListener("click", function() {');
      bgcolorView.style.backgroundColor = bgColorPicker.getValue();
    }, false);
    ...
    saveButton = createButton("save-button", "Save", function() {
      console.log('saveButton = createButton("save-button", "Save", function() {');
      if (editedElement)
        editedElement.contentEditable = false;
      ...
      Array.prototype.forEach.call(docElement.querySelectorAll(".scrapbook-editor"), function(element) {
        console.log('Array.prototype.forEach.call(docElement.querySelectorAll(".scrapbook-editor"), function(element) {');
    ...
    doc.addEventListener("click", function() {
      console.log('doc.addEventListener("click", function() {');
      if (editedElement)
        editedElement.focus();
    }, false);
    return {
  ...
  addEventListener("message", function(event) {
    console.log('addEventListener("message", function(event) {');
  ...
  addEventListener("keydown", function(event) {
    console.log('addEventListener("keydown", function(event) {');
    if (event.ctrlKey && event.keyCode == 83) {
      if (editedElement)
        editedElement.contentEditable = false;
      Array.prototype.forEach.call(document.querySelectorAll(".scrapbook-editor"), function(element) {
        console.log('Array.prototype.forEach.call(document.querySelectorAll(".scrapbook-editor"), function(element) {');
