...
(function() {
  ...
  this.showTab = function(tab, callback) {
    console.log("this.showTab = function(tab, callback)");
  ...
  function init() {
    ...
    pagesLink.onclick = function() {
      console.log("pagesLink.onclick = function()");
      showTab("pages");
    };
    tabsLink.onclick = function() {
      console.log("tabsLink.onclick = function()");
      showTab("tabs");
    };
    tagsLink.onclick = function() {
      console.log("tagsLink.onclick = function()");
      showTab("tags");
    };
    newNoteLink.onclick = function() {
      console.log("newNoteLink.onclick = function()");
      bgPage.createNewNote(prompt("title"));
    };
    newTabLink.onclick = function() {
      console.log("newTabLink.onclick = function()");
      bgPage.openPopup();
    };
    newTabLink.onkeyup = function(event) {
      console.log("newTabLink.onkeyup = function(event)");
      if (event.keyIdentifier == "Enter")
        newTabLink.onclick();
    };
    document.getElementById("firstuse-tabs-link").onclick = function() {
      console.log("document.getElementById(\"firstuse-tabs-link\").onclick = function()");
      showTab("tabs");
    };
    document.getElementById("firstuse-pages-link").onclick = function() {
      console.log("document.getElementById(\"firstuse-pages-link\").onclick = function()");
      showTab("pages");
    };
    initPagesTab();
    initTabsTab();
  ...
  this.onload = function() {
    console.log("this.onload = function()");
